...
export default forwardRef(({}, ref) => {
    ...
    useEffect(() => {
        getBedrockKnowledgeBases().then(kbs => {
            const kbOptions = kbs.map(kb => ({ label: kb.name, value: kb.knowledgeBaseId, iconName: "settings", description: kb.description, tags: ["Status: "+ kb.status, "Start Date: " + formatDates(kb.updatedAt) ]})) 
